...
rem build-dos.cmd
rem
rem Runs build-dos.ps1 from cmd.exe, from a double-click, or from anywhere
...
rem     build-dos.cmd
rem     build-dos.cmd -BuildType Debug -Jobs 8
rem ---------------------------------------------------------------------------
...
"%PS%" -NoProfile -ExecutionPolicy Bypass -File "%~dp0build-dos.ps1" %*
