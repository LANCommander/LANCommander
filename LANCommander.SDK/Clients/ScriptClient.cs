...
namespace LANCommander.SDK.Services
{
        ...
        IConnectionClient connectionClient)
    {
        ...
        #region Tools
        public async Task<bool> RunDetectInstallScriptAsync(string installDirectory, Guid gameId, Tool tool)
        {
            bool result = default;
        ...
        public async Task<int> RunInstallScriptAsync(string installDirectory, Guid gameId, Tool tool)
        {
            int result = default;
        ...
        public async Task<int> RunBeforeStartScriptAsync(string installDirectory, Guid gameId, Tool tool)
        {
            int result = default;
        ...
        public async Task<int> RunAfterStopScriptAsync(string installDirectory, Guid gameId, Tool tool)
        {
            int result = default;
        ...
        public async Task<Package> RunPackageScriptAsync(Script packageScript, Tool tool)
        {
            try
            {
