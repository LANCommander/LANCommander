...
{
    [Cmdlet(VerbsCommon.Get, "GameOptions")]
    [OutputType(typeof(PSObject))]
    public class GetGameOptionsCmdlet : Cmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                schema = deserializer.Deserialize<SDK.Models.OptionSchema>(manifest.OptionSchema);
            }
            catch (Exception ex)
            {
                WriteError(new ErrorRecord(ex, "SchemaParseError", ErrorCategory.ParserError, manifest.OptionSchema));
                return;
            }
            ...
            {
                foreach (var kvp in manifest.Options)
                {
