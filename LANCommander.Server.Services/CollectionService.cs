...
namespace LANCommander.Server.Services
{
    public sealed class CollectionService(
        ...
        IDbContextFactory<DatabaseContext> contextFactory) : BaseDatabaseService<Collection>(logger, settingsProvider, cache, mapper, httpContextAccessor, contextFactory)
    {
