...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ SplitPane)
/* harmony export */ });
...
class SplitPane {
    ...
    Init(paneId) {
        let splitPane = document.querySelector(`#split-pane-${paneId}`);
        if (splitPane != null) {
            let panes = Array.from(splitPane.querySelectorAll('.pane'));
            ...
            (0,split_js__WEBPACK_IMPORTED_MODULE_0__["default"])(panes, opts);
        }
    }
}
...
class Uploader {
    ...
    UploadChunk(chunk) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                let chunkResponse = yield (0,axios__WEBPACK_IMPORTED_MODULE_1__["default"])({
                    method: "post",
                    url: this.ChunkRoute,
                    data: formData,
...
/*!****************!*\
  ...
  \****************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Uploader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Uploader */ "./Uploader.ts");
/* harmony import */ var _SplitPane__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SplitPane */ "./SplitPane.ts");


window.Uploader = new _Uploader__WEBPACK_IMPORTED_MODULE_0__["default"]();
window.SplitPane = new _SplitPane__WEBPACK_IMPORTED_MODULE_1__["default"]();
